...
> [!NOTE]
> You can debug the package code in [Vscode](https://code.visualstudio.com/) by using the [Node.js: Attach to process](https://code.visualstudio.com/docs/nodejs/nodejs-debugging#_setting-up-an-attach-configuration) debug option. For running tests in-editor, use the built-in VSCode Testing UI or a Vitest-compatible extension. See the Vitest docs for editor integration: https://vitest.dev/guide/running-tests.html
