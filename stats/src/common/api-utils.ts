...
export const extractErrorMessages = (
    ...
    const message = hasMessage ? String((err as ErrorWithMessage).message) : "Something went wrong";
 ...
 */
export const toNum = (v: string | number | undefined | null): number | undefined => {
