 ...
 *
 * @param {number|string} value The number (or numeric string) to clamp.
...
const getCardColors = ({
	...
	const defaultTheme = /** @type {any} */ (themes)[fallbackTheme];
	const selectedTheme =
		(typeof theme === "string" && /** @type {any} */ (themes)[theme]) ||
		defaultTheme;
