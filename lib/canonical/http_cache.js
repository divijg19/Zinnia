...
// Runtime JS shim mirroring `safeUrl` in `lib/canonical/http_cache.ts`.
...
// Runtime JS shims mirroring the send helpers in
// `lib/canonical/http_cache.ts`. Always 200 + full body with ETag set;
