...
export function generateCard(
	...
	const safeFontFamily = "Segoe UI, Ubuntu, sans-serif";
	...
	return (
		...
		`<g transform='translate(${totalContributionsOffset}, ${totalContributionsHeightOffset[0]})'><text x='0' y='32' stroke-width='0' text-anchor='middle' fill='${theme.sideNums}' stroke='none' font-family='${safeFontFamily}' font-weight='700' font-size='28px' font-style='normal' style='opacity: 0; animation: fadein 0.5s linear forwards 0.6s'>${totalContributions}</text></g>` +
		`<g transform='translate(${totalContributionsOffset}, ${totalContributionsHeightOffset[1]})'><text x='0' y='32' stroke-width='0' text-anchor='middle' fill='${theme.sideLabels}' stroke='none' font-family='${safeFontFamily}' font-weight='400' font-size='14px' font-style='normal' style='opacity: 0; animation: fadein 0.5s linear forwards 0.7s'>${totalContributionsText}</text></g>` +
		`<g transform='translate(${totalContributionsOffset}, ${totalContributionsHeightOffset[2]})'><text x='0' y='32' stroke-width='0' text-anchor='middle' fill='${theme.dates}' stroke='none' font-family='${safeFontFamily}' font-weight='400' font-size='12px' font-style='normal' style='opacity: 0; animation: fadein 0.5s linear forwards 0.8s'>${totalContributionsRangeText}</text></g>` +
		`</g>` +
		`<g style='isolation: isolate'>` +
		`<g transform='translate(${currentStreakOffset}, ${currentStreakHeightOffset[1]})'><text x='0' y='32' stroke-width='0' text-anchor='middle' fill='${theme.currStreakLabel}' stroke='none' font-family='${safeFontFamily}' font-weight='700' font-size='14px' font-style='normal' style='opacity: 0; animation: fadein 0.5s linear forwards 0.9s'>${currentStreakText}</text></g>` +
		`<g transform='translate(${currentStreakOffset}, ${currentStreakHeightOffset[2]})'><text x='0' y='21' stroke-width='0' text-anchor='middle' fill='${theme.dates}' stroke='none' font-family='${safeFontFamily}' font-weight='400' font-size='12px' font-style='normal' style='opacity: 0; animation: fadein 0.5s linear forwards 0.9s'>${currentStreakRangeText}</text></g>` +
		...
		`<g transform='translate(${currentStreakOffset}, ${currentStreakHeightOffset[0]})'><text x='0' y='32' stroke-width='0' text-anchor='middle' fill='${theme.currStreakNum}' stroke='none' font-family='${safeFontFamily}' font-weight='700' font-size='28px' font-style='normal' style='animation: currstreak 0.6s linear forwards'>${currentStreak}</text></g>` +
		`</g>` +
		`<g style='isolation: isolate'>` +
		`<g transform='translate(${longestStreakOffset}, ${longestStreakHeightOffset[0]})'><text x='0' y='32' stroke-width='0' text-anchor='middle' fill='${theme.sideNums}' stroke='none' font-family='${safeFontFamily}' font-weight='700' font-size='28px' font-style='normal' style='opacity: 0; animation: fadein 0.5s linear forwards 1.2s'>${longestStreak}</text></g>` +
		`<g transform='translate(${longestStreakOffset}, ${longestStreakHeightOffset[1]})'><text x='0' y='32' stroke-width='0' text-anchor='middle' fill='${theme.sideLabels}' stroke='none' font-family='${safeFontFamily}' font-weight='400' font-size='14px' font-style='normal' style='opacity: 0; animation: fadein 0.5s linear forwards 1.3s'>${longestStreakText}</text></g>` +
		`<g transform='translate(${longestStreakOffset}, ${longestStreakHeightOffset[2]})'><text x='0' y='32' stroke-width='0' text-anchor='middle' fill='${theme.dates}' stroke='none' font-family='${safeFontFamily}' font-weight='400' font-size='12px' font-style='normal' style='opacity: 0; animation: fadein 0.5s linear forwards 1.4s'>${longestStreakRangeText}</text></g>` +
		`</g>` +
		`${excludedDays}` +
		`</g></svg>`
	);
