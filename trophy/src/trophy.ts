...
export class TotalReviewsTrophy extends Trophy {
	constructor(score: number) {
		const rankConditions = [
			new RankCondition(RANK.SSS, "God Reviewer", 1000),
			new RankCondition(RANK.SS, "Deep Reviewer", 400),
			new RankCondition(RANK.S, "Super Reviewer", 200),
			new RankCondition(RANK.AAA, "Ultra Reviewer", 100),
			new RankCondition(RANK.AA, "Hyper Reviewer", 50),
			new RankCondition(RANK.A, "Active Reviewer", 20),
			new RankCondition(RANK.B, "Intermediate Reviewer", 10),
